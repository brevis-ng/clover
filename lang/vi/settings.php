...
return [
    ...
    "bot_token" => "Bot Token",
    "webapp_inline_button" => "Tiêu đề nút nội tuyến",
    "inline_btn_hint" => "Tiêu đề nút ấn đính kèm phía dưới tin nhắn của bot",
    "webapp_menu_button" => "Tiêu đề nút MenuButton",
    "webapp_url" => "WebApp Url",
    "webapp_url_hint" => "Địa chỉ https được gọi khi người dùng khởi tạo WebApp",
    "should_send_start_msg" => "Gửi tin nhắn chào mừng",
    ...
    "content" => "Nội dung",
    "crontab" => "Biểu thức lịch trình",
    "image" => "Hình ảnh",
    "image_hint" => "Ảnh rõ nét, có tỷ lệ 4:3, độ phân giải có thể là 640x480, 800x600, 1280x960",
    "cron_desc" => "Biểu thức lịch trình cron tạo thành từ 5 trường phút, giờ, ngày, tháng, tuần. Tham khảo thêm tại [https://crontab.guru] hoặc [https://cronexpressiontogo.com]",
